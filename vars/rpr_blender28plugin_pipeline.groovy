    ...
    switch(osName)
    {
        ...
        case "OSX":
            ...
            if (options.isPreBuilt) {
                ...
                if(!options.pluginOSXSha && !fileExists("${CIS_TOOLS}/../PluginsBinaries/${options.pluginOSXSha}.zip"))
                {
                    clearBinariesUnix()
        ...
        default:
            ...
            if (options.isPreBuilt) {
                ...
                if(!options.pluginUbuntuSha && !fileExists("${CIS_TOOLS}/../PluginsBinaries/${options.pluginUbuntuSha}.zip"))
                {
                    clearBinariesUnix()
